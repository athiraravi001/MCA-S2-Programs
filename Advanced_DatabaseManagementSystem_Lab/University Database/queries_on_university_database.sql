-- ************ Add a new department "civil engineering" to the departments table ************  
...
-- ************ Insert a new student mark taylor into the students table ************  
...
-- ************ Add a new course "structural analysis" to the courses table ************  
...
-- ************ Enroll Mark Taylor in Structural Analysis with grade 'B' ************ 
...
-- ************ Update bob smith's email from bob@example.com to bob.smith@example.com in the students table ************ 
...
-- ************ Change Charlie Brown's grade in "database systems" (course_id: 501) from c to b in the enrollments table ************ 
...
-- ************ Rename the department "Mechanical Engineering" to "Mechatronics" in the departments table ************ 
...
-- ************ Retrieve the list of all students and their corresponding departments ************ 
...
-- ************ Display students enrolled in "Database Systems" (course_id: 501) along with their grades ************ 
...
-- ************ List the students who have received an 'A' grade in any course ************ 
...
-- ************ Show the courses offered by the "Computer Science" department ************ 
...
-- ************ Find the top 3 students who are enrolled in the most courses ************ 
...
-- ************ Remove Mark Taylor from the students table ************ 
...
-- ************ Delete all enrollments for students who have failed (Grade = 'F') ************ 
...
-- ************ Delete the course "Circuit Analysis" (course_id: 503) from the courses table ************ 
...
-- ************ Remove all students who are older than 25 years ************ 
